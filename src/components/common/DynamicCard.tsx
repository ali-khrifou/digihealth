...
export const DynamicCard = ({ title, count, logo, typeChart, percent, progress, secondeIcon, unité }: IDynamicCardProps) => {
    return (
        ...
        <div className='grid lg:grid-cols-5 md:grid-cols-2 sm:grid-cols-1  w-auto bg-white rounded-lg p-3 m-5 max-h-auto'>
            <div className='col-span-3 flex flex-col items-start justify-start w-[100%]'>
                <p className="text-[#25265E] text-xs font-semibold">{title}</p>
                <h3 className='text-[#0DA8AE] text-2xl font-bold mt-5 flex gap-2 items-center w-[100%]'>
            ...
            <div className="col-span-2 flex flex-col flex-wrap align-top items-end my-5 gap-2">
